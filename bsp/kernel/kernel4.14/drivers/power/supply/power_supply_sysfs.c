...
static const char * const power_supply_batt_id_text[] = {
	"T19655-Gaoyuan-5050mAh", "T19655-Fenghua-5050mAh", "Non-standard-battery"
};
//-SCT-702, fangduozhu.wt, modify, 20210916, battery bringup
...
//+SCT-702, fangduozhu.wt, modify, 20210916, battery bringup
	else if (off == POWER_SUPPLY_PROP_BATT_ID_SELECT)
		return sprintf(buf, "%s\n",
					power_supply_batt_id_text[value.intval]);
//-SCT-702, fangduozhu.wt, modify, 20210916, battery bringup
...
//SCT-702, fangduozhu.wt, modify, 20210916, battery bringup
	POWER_SUPPLY_ATTR(batt_id_select),
