...
//	return read32(&reg->DSI_MODE_CFG);
	return read32(&reg->DSI_MODE_CFG) & BIT(0); //Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
}
/**
...
static struct dsi_core_ops dsi_ctrl_ops = {
	...
	.vblk_cmd_trans_limit           = dsi_vblk_cmd_trans_limit,	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
