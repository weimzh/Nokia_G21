...
//static int vfp;	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
		     ...
		     struct sprd_dpu_layer layers[], u8 count)
{
	...
	dpu_scaling(ctx, layers, count); //del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
#if 0
