...
static int vfp;	//add by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
module_param(time, int, 0644);
module_param(secure_debug, int, 0644);
//static u8 skip_layer_index; //del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
...
//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9) begin
static void dpu_framerate(struct dpu_context *ctx, u8 *count)
{
	struct dpu_reg *reg = (struct dpu_reg *)ctx->base;
	struct sprd_dpu *dpu = (struct sprd_dpu *)container_of(ctx,
							struct sprd_dpu, ctx);
//Modify by pengzhenhua1@wingtech.com for SCP-2710,wt Fix dynamic frame rate adjustment bug(2021.11.25) begin
	if (ctx->is_stopped) {
		pr_err("dpu is stoped\n");
		mode_changed = false;
		return;
	}
//Modify by pengzhenhua1@wingtech.com for SCP-2710,wt Fix dynamic frame rate adjustment bug(2021.11.25) end
	if(mode_changed) {
		dpu_stop(ctx);
...
//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9) end
...
{
	int i;
	u16 src_w; //del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
	u16 src_h; //del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
//	struct sprd_dpu_layer *btm_layer;
	int secure_en = 0;			//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
	struct sprd_dpu_layer *top_layer;	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
	struct dpu_reg *reg = (struct dpu_reg *)ctx->base; //del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
...
//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9) end
	...
	if (mode_changed) {
		//btm_layer = &layers[0];
		top_layer = &layers[count - 1]; //Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
		pr_debug("------------------------------------\n");
		for (i = 0; i < count; i++) {
			pr_debug("layer[%d] : %dx%d --- (%d)\n", i,
				layers[i].dst_w, layers[i].dst_h,
				scale_copy.in_w);
//			if (layers[i].dst_w != scale_copy.in_w) {	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
//				skip_layer_index = i;			//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
//				break;					//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
//			}						//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
		}

//		if  (btm_layer->dst_w <= scale_copy.in_w) {
		if  (top_layer->dst_w < scale_copy.in_w) {	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
			dpu_sr_config(ctx);
			mode_changed = false;
//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
...
//del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7) begin
#if 1
	else if (secure_en == 1){
		if (count == 1) {
			top_layer = &layers[count - 1];
...
#endif
//del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7) end
}
		     ...
		     struct sprd_dpu_layer layers[], u8 count)
{
	...
	dpu_signal_scaling(ctx, layers, count);		//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
...
//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.9)
	...
	for (i = 0; i < count; i++) {
//		if (skip_layer_index == i && skip_layer_index) {	//del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
//			skip_layer_index = 0;				//del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
//			break;						//del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
//		}							//del by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
