			...
			const char *buf, size_t count)
{
	...
	struct drm_encoder *encoder = panel->base.connector->encoder;	//Modify by pengzhenhua1@wingtech.com for SCP-2710,wt Fix dynamic frame rate adjustment bug(2021.11.25)
...
static struct attribute *dpu_attrs[] = {
	...
	&dev_attr_modeset.attr,	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
