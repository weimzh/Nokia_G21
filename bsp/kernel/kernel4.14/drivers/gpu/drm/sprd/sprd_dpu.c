...
bool dynamic_framerate_mode; //Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
				...
				struct device_node *np)
{
	...
	mutex_init(&ctx->vrr_lock);	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
...
static int sprd_dpu_probe(struct platform_device *pdev)
{
	...
	struct sprd_dpu *dpu;
	const char *str;
	int ret;	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.10.19)
...
//	if (!of_property_read_u32(np, "sprd,dpi-clk-div", &val))		//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.10.19)
