...
struct dpu_context {
	...
	struct mutex vrr_lock;	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
...
//	int dpi_clk_div;	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.10.19)
	...
	bool dsc_en;
	int  dsc_mode;
	int vrefresh;	//Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
};
...
extern bool dynamic_framerate_mode; //Modify by pengzhenhua1@wingtech.com for SCT-702,wt dynamic frame rate adjustment bringup on(2021.9.7)
