...
static struct hx9031a_addr_val_pair hx9031a_reg_init_list[] = {
    ...
    {RA_PRF_CFG_0x02,                  0x0a}, //odr 0x0B: 33ms 0x03: 6ms //0X11
    {RA_RANGE_7_0_0x0D,                0X11}, //range ch1 ch0 1.25p
    {RA_RANGE_9_8_0x0E,                0X01}, //range ch3 1.25p ch2 1.25pf
    {RA_AVG0_NOSR0_CFG_0x10,           0x11}, //ch0 osr 512 avg 1 warm 16.
    {RA_NOSR12_CFG_0x11,               0x55}, //0x54 ch2 osr 512; ch1 osr 512
    {RA_NOSR43_CFG_0x12,               0x15}, //ch3 osr 512
    {RA_AVG12_CFG_0x13,                0x00}, //ch1 and ch2 avg 1
    {RA_AVG34_CFG_0x14,                0x00}, //ch3 avg 1
    {RA_SAMPLE_NUM_7_0_0x1f,           0x32}, //sample frequency 0x96: 31K. 0x4B 62K, 0x3a 83K
    {RA_INTEGRATION_NUM_7_0_0x21,      0x32}, //sample frequency 0x96: 31K. 0x4B 62K, 0x3a 83K
    {RA_MOD_RST_CFG_0x28,              0xf5}, //change offset cali delay
    //modify by chenweican@wingtech.com for bug 708293 modify sar distance on 2021-12-15 begin   
    {RA_LP_ALP_1_0_CFG_0x2a,           0x44}, //ch1 LP alpha 4. ch0 LP alpha 4 //0x33
    {RA_LP_ALP_3_2_CFG_0x2b,           0x44}, //ch3 LP alpha 4. ch2 LP alpha 4 //0x33
    {RA_OFFSET_DAC1_7_0_0x17,        0x09},
    ...
    {RA_PROX_INT_HIGH_CFG_0x6c,        0x03}, //prox int high count.  接近中断防抖
    {RA_PROX_INT_LOW_CFG_0x6d,         0x03}, //prox int low count.  远离中断防抖
    ...
    {RA_DSP_CONFIG_CTRL0_0xc3,         0xf0}, //bsline����offsetУ׼��Чλ only open bit3 bit0; ch2 close force zero.
